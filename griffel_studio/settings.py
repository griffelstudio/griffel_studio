"""
Django settings for griffel_studio project.
...
SECRET_KEY = 'c_=+)%%aa^0(7pgilfj47)(989@yydftr)-eqr%70-qifl$ri_'
...
ROOT_URLCONF = 'griffel_studio.urls'
...
WSGI_APPLICATION = 'griffel_studio.wsgi.application'
